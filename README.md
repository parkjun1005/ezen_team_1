...
## 프로젝트 소개
- 리액트와 스프링부트, 데이터베이스를 연결하여 만든 프로젝트로서, localhost 주소를 이용해 백엔드와
프론트엔드 간의 데이터 연동을 구현하였습니다.
- 이 프로젝트는 요즘 흐름에 맞춰 증가하는 SNS와 인터넷 사용에 대응하여, 사용자 친화적인 예약 시스템과 정보
제공 플랫폼을 목표로 설계되었습니다

## 프로젝트 주요 기능
 1. 실시간 예약 시스템 – 날짜별 예약 가능 여부 확인 및 예약 확정 기능
 2. 회원 관리 – 로그인, 회원가입, 사용자별 예약 내역 저장 및 리뷰 작성 기능
 3. 결제 시스템 – 다양한 결제 API를 활용한 온라인 결제 지원


## 멤버
 |박준(팀장)|        김지홍      |     윤진서     |          편무빈        |        조혜린  |     
| :------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------: | 
| <div height=400>예약/결제</div>  | <div height=400>게시판작성/게시판리스트 </div>| <div height=400>회원가입/로그인</div> | <div height=400>캠핑장 소개/오시는 길 페이지</div> | <div height=400>메인 페이지/팝업 </div>| 
...
<h3>Front</h3><div> <img src="https://img.shields.io/badge/html5-%23E34F26.svg?style=for-the-badge&logo=html5&logoColor=white" />&nbsp
  <img src="https://img.shields.io/badge/css3-%231572B6.svg?style=for-the-badge&logo=css3&logoColor=white" />&nbsp <img src="https://img.shields.io/badge/react-%2320232a.svg?style=for-the-badge&logo=react&logoColor=%2361DAFB" />&nbsp </div>
<h3>Back</h3> <div>
...
<h3>Tool</h3><div> <img src="https://img.shields.io/badge/IntelliJIDEA-000000.svg?style=for-the-badge&logo=intellij-idea&logoColor=white" />&nbsp <img src="https://img.shields.io/badge/Visual%20Studio%20Code-0078d7.svg?style=for-the-badge&logo=visual-studio-code&logoColor=white" />&nbsp <img src="https://img.shields.io/badge/figma-%23F24E1E.svg?style=for-the-badge&logo=figma&logoColor=white" /></div>
<h3>os</h3>window
</div>
